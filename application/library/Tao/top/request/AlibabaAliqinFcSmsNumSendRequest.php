 ...
 */
class Tao_top_request_AlibabaAliqinFcSmsNumSendRequest
{
	/** 
	...
	public function check()
	{
		...
		Tao_top_RequestCheckUtil::checkNotNull($this->recNum,"recNum");
		Tao_top_RequestCheckUtil::checkNotNull($this->smsFreeSignName,"smsFreeSignName");
		Tao_top_RequestCheckUtil::checkNotNull($this->smsTemplateCode,"smsTemplateCode");
		Tao_top_RequestCheckUtil::checkNotNull($this->smsType,"smsType");
	}
